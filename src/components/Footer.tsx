        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            ...
            <p className="text-sage-200 text-base leading-relaxed max-w-md mb-6">
              ...
              promoting well-being, sustainability, and harmony in your 
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="mb-6 lg:mb-0">
              ...
              <div className="flex space-x-6 mt-2">
                <Link href="/privacy" className="text-sage-400 hover:text-sage-200 text-xs transition-colors">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="text-sage-400 hover:text-sage-200 text-xs transition-colors">
                  Terms of Service
                </Link>
                <Link href="/accessibility" className="text-sage-400 hover:text-sage-200 text-xs transition-colors">
                  Accessibility
                </Link>
              </div>
            </div>
