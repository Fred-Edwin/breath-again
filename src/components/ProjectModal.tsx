          ...
          >
            ...
            <div className="p-6 border-b border-sage-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-forest-600 font-medium">{project.subtitle}</p>
              </div>
            ...
            <div className="max-h-[calc(90vh-200px)] overflow-y-auto">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Left Column - Details */}
                  <div>
                    <h3 className="text-lg font-semibold text-forest-900 mb-3">Project Overview</h3>
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center text-sm text-forest-600">
                        <svg className="w-4 h-4 mr-2 text-forest-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-forest-900 mb-3">Project Tags</h3>
