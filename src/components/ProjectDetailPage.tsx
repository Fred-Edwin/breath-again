...
export default function ProjectDetailPage({ project }: ProjectPageProps) {
  ...
  const [imageFilter, setImageFilter] = useState<'all' | 'before' | 'after' | 'main' | 'detail'>('all')

  const filteredImages = project.images.filter(image => 
    imageFilter === 'all' || image.type === imageFilter
  )
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className={`relative py-20 md:py-32 bg-gradient-to-br ${getCategoryColor(project.category)} text-white overflow-hidden`}>
          ...
          >
            <div>
              ...
              <div className="flex items-center space-x-6 text-white/80 mb-8">
                ...
                <div className="flex items-center space-x-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V6a2 2 0 012-2h4a2 2 0 012 2v1m-6 0h6a2 2 0 012 2v10a2 2 0 01-2 2H8a2 2 0 01-2-2V9a2 2 0 012-2z" />
                  </svg>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  <div>
                    <h3 className="text-xl font-semibold text-forest-900 mb-4">The Challenge</h3>
                    <p className="text-forest-600 leading-relaxed">
                      {project.details.challenge}
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-forest-900 mb-4">Our Solution</h3>
                    <p className="text-forest-600 leading-relaxed">
            ...
            <div>
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h3 className="text-lg font-semibold text-forest-900 mb-6">Project Details</h3>
                
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-semibold text-forest-700 mb-1">Timeline</h4>
                    <p className="text-forest-600">{project.details.timeline}</p>
                  </div>
                  
                  {project.details.budget && (
                    <div>
                      <h4 className="text-sm font-semibold text-forest-700 mb-1">Investment</h4>
                      <p className="text-forest-600">{project.details.budget}</p>
                    </div>
                  )}

                  <div>
                    <h4 className="text-sm font-semibold text-forest-700 mb-2">Key Features</h4>
                    <ul className="space-y-1">
                      {project.details.features.slice(0, 4).map((feature, index) => (
                        <li key={index} className="text-sm text-forest-600 flex items-start">
                          <svg className="w-4 h-4 text-sage-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-forest-700 mb-2">Tags</h4>
                    <div className="flex flex-wrap gap-1">
                      {project.tags.map(tag => (
                        <span key={tag} className="px-2 py-1 bg-sage-100 text-forest-600 text-xs rounded">
                          {tag}
                        </span>
                      ))}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-forest-600 max-w-2xl mx-auto">
              Explore the transformation through our detailed project photography
            </p>
          </motion.div>
            ...
            {images[currentImageIndex]?.type && (
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 bg-white/90 text-forest-700 text-sm font-semibold rounded-full">
                  {images[currentImageIndex].type.charAt(0).toUpperCase() + images[currentImageIndex].type.slice(1)}
                </span>
              </div>
            )}
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-forest-600 max-w-2xl mx-auto">
                Measurable results that demonstrate the success of our biophilic design approach
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <div className="text-sage-200">
                <div className="font-semibold text-lg">{project.details.testimonial.author}</div>
                <div className="text-sage-300">{project.details.testimonial.role}</div>
                {project.details.testimonial.company && (
                  <div className="text-sage-300">{project.details.testimonial.company}</div>
                )}
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-forest-600 mb-8 max-w-2xl mx-auto">
              Let's create something beautiful together. Get in touch to discuss your biophilic design project.
            </p>
