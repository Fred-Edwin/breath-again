...
export default function HomeFeatures() {
  ...
  const features = [
    {
      icon: (
        <svg className="w-6 h-6 text-forest-700 dark:text-sage-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "Science-Based",
      description: "Evidence-driven design principles backed by research in environmental psychology and human well-being.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-forest-600 dark:text-sage-300 max-w-2xl mx-auto">
              Our approach combines ancient wisdom with modern science to create spaces that nurture both you and the planet.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`absolute inset-0 ${feature.bgColor} opacity-50 transition-all duration-300 ${feature.hoverBgColor}`} />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-sage-200 mb-8 max-w-2xl mx-auto">
              Let's create an environment that nurtures your well-being and connects you with the healing power of nature.
            </p>
