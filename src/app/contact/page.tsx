        ...
        >
          <div className="text-center">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Ready to transform your space with biophilic design? Let&apos;s start the conversation.
            </motion.p>
            ...
            >
              <div>
                ...
                <p className="text-lg text-forest-600 leading-relaxed mb-8">
                  We&apos;re here to help you create spaces that nurture your well-being and connect you with nature. 
              ...
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <h3 className="text-lg font-semibold text-forest-900 mb-3">Free Consultation</h3>
                <p className="text-forest-600 mb-4">
                  Book a complimentary 30-minute consultation to discuss your project and learn how biophilic design can transform your space.
                </p>
                <Link 
                  href="#"
