...
export default function AnimationsDemo() {
  const cardData = [
    ...
    },
    {
      ...
      description: 'Subtle animations on hover and click',
    },
    {
      title: 'Theme Transitions',
      description: 'Smooth color transitions between themes',
    },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-forest-900 transition-colors duration-500">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollReveal direction="up" delay={0.2}>
            <p className="text-xl md:text-2xl text-forest-700 dark:text-sage-300 mb-8 leading-relaxed">
              Experience the power of biophilic design enhanced with smooth,
      ...
      <section
        id="features"
        className="py-20 bg-white dark:bg-forest-900 transition-colors duration-500"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal direction="up">
            <h2 className="text-4xl font-serif font-bold text-forest-900 dark:text-sage-100 text-center mb-12 heading-nature">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggeredList staggerDelay={0.2} direction="up">
            {[
              ...
              <div
                key={index}
                className="bg-white dark:bg-forest-700 p-6 rounded-xl mb-4 shadow-sm border border-sage-200 dark:border-forest-600 transition-colors duration-300"
              >
          ...
          <ScrollReveal direction="up">
            <div className="bg-white dark:bg-forest-700 p-8 rounded-2xl shadow-organic border border-sage-200 dark:border-forest-600 transition-colors duration-300">
              ...
              <p className="text-forest-600 dark:text-sage-400 leading-relaxed">
                ...
                <code className="bg-sage-100 dark:bg-forest-600 px-2 py-1 rounded text-sm">
                  prefers-reduced-motion
                </code>{' '}
                setting. Users who prefer reduced motion will see minimal or no
                animations while maintaining full functionality.
              </p>
            </div>
          </ScrollReveal>
        </div>
