  ...
  const services = [
    {
      ...
      description:
        'Transform indoor spaces with natural elements, living walls, natural lighting, and organic materials that promote well-being.',
      features: [
        'Living walls & green installations',
    ...
    },
    {
      ...
      description:
        'Create outdoor spaces that seamlessly blend with natural ecosystems while providing peaceful retreats for daily life.',
      features: [
    ...
    },
    {
      ...
      description:
        'Specialized environments designed to reduce stress, improve focus, and enhance mental health through nature connection.',
      features: [
        'Meditation & yoga spaces',
        'Therapeutic gardens',
        'Sensory design elements',
        'Circadian lighting',
        'Sound & aromatherapy integration',
      ],
      icon: (
        <svg
          className="w-8 h-8"
    ...
    },
    {
      ...
      description:
        'Expert guidance on eco-friendly materials, energy efficiency, and sustainable design practices for any project.',
      features: [
    ...
    },
    {
      ...
      description:
        'Boost productivity and employee well-being with nature-inspired office environments and collaborative spaces.',
      features: [
    ...
    },
    {
      ...
      description:
        'Breathe new life into existing spaces by incorporating biophilic elements and sustainable improvements.',
      features: [
      ...
      <section className="bg-gradient-to-r from-forest-100 to-sage-100 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-forest-700 leading-relaxed">
            Comprehensive biophilic design solutions that reconnect your spaces
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {services.map((service, index) => (
              <article
                key={index}
                className="group bg-sage-25 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, featureIndex) => (
                      ...
                      >
                        <svg
                          className="w-5 h-5 text-sage-500 mr-3 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-forest-600 max-w-2xl mx-auto">
              A collaborative approach that ensures every project reflects your
              vision while maximizing the benefits of biophilic design.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Discovery',
                description:
                  'Understanding your needs, space, and vision through detailed consultation.',
              },
              {
                step: '02',
                title: 'Design',
                description:
                  'Creating detailed plans that integrate natural elements with your lifestyle.',
              },
              {
                step: '03',
                title: 'Development',
                description:
                  'Bringing designs to life with sustainable materials and expert craftsmanship.',
              },
              {
                step: '04',
                title: 'Delivery',
                description:
                  'Final installation and ongoing support to ensure your space thrives.',
              },
            ].map((process, index) => (
      ...
      <section className="py-20 bg-forest-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-sage-200 mb-8 max-w-2xl mx-auto">
            Let&apos;s discuss how we can transform your space with the healing
            power of nature.
          </p>
