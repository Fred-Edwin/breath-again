...
export class EmailService {
  ...
  static async sendProjectInquiry(data: ProjectInquiryData): Promise<void> {
    const endpoint =
      process.env.NEXT_PUBLIC_PROJECT_INQUIRY_ENDPOINT || FORMSPREE_ENDPOINT
  ...
  static async subscribeNewsletter(data: NewsletterData): Promise<void> {
    const endpoint =
      process.env.NEXT_PUBLIC_NEWSLETTER_ENDPOINT || FORMSPREE_ENDPOINT
   ...
   */
  private static async sendToFormspree(
    endpoint: string,
    data: ContactFormData | ProjectInquiryData | NewsletterData
  ): Promise<void> {
   ...
   */
  private static async sendToNetlify(
    formName: string,
    data: ContactFormData | ProjectInquiryData | NewsletterData
  ): Promise<void> {
   ...
   */
  private static async sendToCustomAPI(
    endpoint: string,
    data: ContactFormData | ProjectInquiryData | NewsletterData
  ): Promise<void> {
    const response = await fetch(endpoint, {
